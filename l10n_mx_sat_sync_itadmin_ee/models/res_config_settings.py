...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            ...
            buscar_producto_por_clave_sat=self.env['ir.config_parameter'].with_user(self.env.user).get_param('l10n_mx_sat_sync_itadmin_ee.buscar_producto_por_clave_sat'),
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].with_user(self.env.user).set_param('l10n_mx_sat_sync_itadmin_ee.buscar_producto_por_clave_sat', self.buscar_producto_por_clave_sat)
